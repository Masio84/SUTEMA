...
export function ThemeToggle() {
    ...
    if (!mounted) {
        return <div className="h-9 w-9 border border-border/50 rounded-xl bg-background/50" />
    }

    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-xl border border-border/50 bg-background/50 hover:bg-accent transition-all">
